...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CeZKJ3YQ.mjs");
...
var manifest = {
	"9954c43fd601ae948e4679f42e17f11705eab224b805183bbfa7d935436c25eb": {
		functionName: "checkAiAvailable_createServerFn_handler",
		importer: () => import("./generate-DhglbcAz.mjs")
	},
	"d23950bc48f6fb0181df135e34b5c0c093e51e1b3dd59cf4b814ced3b94ccf26": {
		functionName: "generateStyledImage_createServerFn_handler",
		importer: () => import("./generate-DhglbcAz.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CBnq3RWd.mjs").then((n) => n.t),
