...
export const COPY = {
  vi: {
    ...
    tagline: "274 phong cách vẽ tay · 117 bố cục · chọn · viết chủ đề · tạo ảnh",
    studio: "Studio",
    gallery: "Thư viện",
    jobs: "Hàng đợi",
    results: "Kết quả",
    ...
    searchLayouts: "Tìm SC / IG / SB hoặc tên bố cục…",
  ...
  en: {
    appName: "Handraw Studio",
    tagline: "274 hand-drawn styles · 117 layouts · pick · prompt · generate",
    studio: "Studio",
    gallery: "Gallery",
    jobs: "Queue",
    results: "Results",
    ...
    searchLayouts: "Search SC / IG / SB or layout name…",
